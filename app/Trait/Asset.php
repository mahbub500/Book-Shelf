...
trait Asset {
	 ...
	 * @param string $ver       Script version, defaults to the constant BOOKSHELF_VERSION.
	 * @param bool   $args		Optional arguments.
	 */
	public function register_script( $handle, $src, $deps = [], $ver = null, $args = [] ) {
	 ...
	 */
	public function enqueue_script( $handle, $src, $deps = [], $ver = null, $args = [ 'in_footer' => true ] ) {
	 ...
	 * @param string $ver    Style version, defaults to the constant BOOKSHELF_VERSION.
	 ...
	 * Otherwise, returns the specified version or the BOOKSHELF_VERSION constant if no version is provided.
	 *
	 ...
	 */
	private function get_ver( $version ) {
